...
import { CircleAlert as AlertCircle, TrendingDown, Users } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          {problems.map((problem, index) => (
            <Card
              key={index}
              className="border-2 border-gray-100 hover:border-[#2563EB] hover:shadow-xl transition-all duration-300 bg-gradient-to-br from-white via-red-50/20 to-gray-50/60"
            >
