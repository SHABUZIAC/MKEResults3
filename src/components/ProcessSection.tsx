        ...
        <div className="grid md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <div key={index} className="relative">
              ...
              <Card className="border-2 border-gray-100 hover:border-[#2563EB] hover:shadow-xl transition-all duration-300 h-full bg-gradient-to-br from-white via-blue-50/10 to-blue-100/40">
